...
Najprej bova sestavila pomožno funkcijo, ki bi za argumente prejela seznam treh seznamov. V vsakem seznamu bi bilo 6 naravnih števil, ki bi predstavljale števila na kocki.
Funkcija bi vrnila minimalno verjetnost, ki bi jo dobila iz primerjav seznamov, da med danimi kockami ne velja tranzitivnost. Nato bi naredila krovno funkcijo, ki bi sprejela
...
\section{Primeri tranzitivnih kock}
...
\begin{itemize}
    ...
    \item D: 5, 5, 5, 1, 1, 1
\end{itemize}
\\\includegraphics[width=100mm]{FP_12_nal_kratko_p.png}
